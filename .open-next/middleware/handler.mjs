...
var BuildId = "ITKSVHZca4vn0n_7sa4aH";
...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/admin(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/admin/:path*" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "ITKSVHZca4vn0n_7sa4aH", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "pRzd0VDl8dt6t8EXSwyr4LYBr6sqXJ/XaMwuPEZ0mB4=", "__NEXT_PREVIEW_MODE_ID": "a0ded6577af34c3a0e8e17d1750ab57e", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "9adcb1133c3d34508ef562f5f7b738d823cb606102247932235891f14124a051", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "c45e8e65462831c605c5f70be516a2bf5ae7752dbad9e7bbaae289f6d683441e" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/admin/barbers/route": "/api/admin/barbers", "/api/admin/change-password/route": "/api/admin/change-password", "/api/admin/override-status/route": "/api/admin/override-status", "/api/admin/login/route": "/api/admin/login", "/api/admin/parsed-statuses/route": "/api/admin/parsed-statuses", "/api/admin/me/route": "/api/admin/me", "/api/admin/sync-all/route": "/api/admin/sync-all", "/api/admin/upload/route": "/api/admin/upload", "/api/admin/users/route": "/api/admin/users", "/api/analytics/events/route": "/api/analytics/events", "/api/analytics/stats/route": "/api/analytics/stats", "/api/parse-yclients-html/route": "/api/parse-yclients-html", "/api/parse-yclients/route": "/api/parse-yclients", "/favicon.ico/route": "/favicon.ico", "/admin/analytics/page": "/admin/analytics", "/admin/barbers/[id]/edit/page": "/admin/barbers/[id]/edit", "/admin/login/page": "/admin/login", "/admin/dashboard/page": "/admin/dashboard", "/admin/page": "/admin", "/admin/portfolio/page": "/admin/portfolio", "/admin/barbers/new/page": "/admin/barbers/new", "/admin/profile/page": "/admin/profile", "/admin/users/page": "/admin/users", "/page": "/", "/barbers/[id]/page": "/barbers/[id]" };
