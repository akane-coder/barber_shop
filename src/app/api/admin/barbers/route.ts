...
export async function GET(req: NextRequest) {
  ...
  try {
    const barbers = (await getData<Barber[]>('barbers_data', 'barbers.json')) || [];
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const currentBarbers = (await getData<Barber[]>('barbers_data', 'barbers.json')) || [];
    ...
    await setData('barbers_data', 'barbers.json', currentBarbers);
...
export async function DELETE(req: NextRequest) {
  ...
  try {
    ...
    await setData('barbers_data', 'barbers.json', filtered);
